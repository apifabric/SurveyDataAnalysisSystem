...
resourcename="surveydataanalysissystem"  # lower case, only
resourcegroup="surveydataanalysissystem_rg"
...
# git clone https://github.com/apilogicserver/surveydataanalysissystem.git
# cd surveydataanalysissystem
...
az group create --name surveydataanalysissystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group surveydataanalysissystem_rg --sku S1 --is-linux
az container create --resource-group surveydataanalysissystem_rg --name surveydataanalysissystem --image apilogicserver/surveydataanalysissystem:latest --dns-name-label surveydataanalysissystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//surveydataanalysissystem.westus.azurecontainer.io:5656'

...
@Component({
  selector: 'Surveyresponsesummary-home',
  templateUrl: './Surveyresponsesummary-home.component.html',
  styleUrls: ['./Surveyresponsesummary-home.component.scss']
})
export class SurveyresponsesummaryHomeComponent implements AfterViewInit {

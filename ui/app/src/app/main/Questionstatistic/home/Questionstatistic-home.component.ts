...
@Component({
  selector: 'Questionstatistic-home',
  templateUrl: './Questionstatistic-home.component.html',
  styleUrls: ['./Questionstatistic-home.component.scss']
})
export class QuestionstatisticHomeComponent implements AfterViewInit {

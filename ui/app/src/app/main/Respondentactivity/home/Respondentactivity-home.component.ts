...
@Component({
  selector: 'Respondentactivity-home',
  templateUrl: './Respondentactivity-home.component.html',
  styleUrls: ['./Respondentactivity-home.component.scss']
})
export class RespondentactivityHomeComponent implements AfterViewInit {

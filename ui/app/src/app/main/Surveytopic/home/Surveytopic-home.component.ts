...
@Component({
  selector: 'Surveytopic-home',
  templateUrl: './Surveytopic-home.component.html',
  styleUrls: ['./Surveytopic-home.component.scss']
})
export class SurveytopicHomeComponent implements AfterViewInit {

...
@Component({
  selector: 'Questiontype-home',
  templateUrl: './Questiontype-home.component.html',
  styleUrls: ['./Questiontype-home.component.scss']
})
export class QuestiontypeHomeComponent implements AfterViewInit {

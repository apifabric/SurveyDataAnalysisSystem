...
@Component({
  selector: 'Surveystatistic-home',
  templateUrl: './Surveystatistic-home.component.html',
  styleUrls: ['./Surveystatistic-home.component.scss']
})
export class SurveystatisticHomeComponent implements AfterViewInit {
